    ...
    return (
      <>
        ...
        <div className="cardList">
          ...
          <GameCard gameName={"Battleship"} imgPath={"./public/images/banners/battleship banner.jpg"} playerCount={2} gameDuration={"20 min."} />
          <GameCard gameName={"Connect 4"} imgPath={"public/images/banners/connect 4 banner.jpg"} playerCount={2} gameDuration={"15 min."} />
