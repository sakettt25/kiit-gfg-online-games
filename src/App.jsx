    ...
    return (
      <>
        ...
        <div className="cardList">
          ...
          <GameCard gameName={"Game Name"} imgPath={"src/assets/banners/placeholderbanner2.jpg"} playerCount={4} gameDuration={"5 min."} />

          <GameCard gameName={"Game Name"} imgPath={"src/assets/banners/placeHolderBanner.png"} playerCount={4} gameDuration={"5 min."} />
          <GameCard gameName={"Game Name"} imgPath={"src/assets/banners/placeHolderBanner3.jpg"} playerCount={4} gameDuration={"5 min."} />
          <GameCard gameName={"Game Name"} imgPath={"src/assets/banners/placeholderbanner2.jpg"} playerCount={4} gameDuration={"5 min."} />
          <GameCard gameName={"Game Name"} imgPath={"src/assets/banners/placeHolderBanner3.jpg"} playerCount={4} gameDuration={"5 min."} />
